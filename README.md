...
## After downloading, unzip, and drag the model folders contained (ViT-Base, ConvNext, etc.) into the `models/` folder
...
### DeiT-Small is included in the repo as the model is only 82MB.
